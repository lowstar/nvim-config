function _G.tweak_colors()
    ...
    if vim.g.colors_name:find("^base16") ~= nil then
        ...
        vim.fn.Base16hi("LspDiagnosticsDefaultHint", vim.g.base16_gui0C, '', '', '', '', '')
        vim.fn.Base16hi("LspDiagnosticsUnderlineError", vim.g.base16_gui08, '', '', '', 'underline', 'underline')
        vim.fn.Base16hi("LspDiagnosticsUnderlineWarning", vim.g.base16_gui09, '', '', '', 'underline', 'underline')
        vim.fn.Base16hi("LspDiagnosticsUnderlineInformation", vim.g.base16_gui0A, '', '', '', 'underline', 'underline')
        vim.fn.Base16hi("LspDiagnosticsUnderlineHint", vim.g.base16_gui0C, '', '', '', 'underline', 'underline')
